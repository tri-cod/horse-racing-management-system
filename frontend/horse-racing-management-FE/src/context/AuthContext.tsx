...
export function AuthProvider({ children }: { children: ReactNode }) {
 ...
 // Notify the server first (best-effort) while the token is still attached to the request
 logoutApi().catch(() => {});
 // Then clear local session — don't block the user waiting for the server
 tokenStorage.clear();
 setToken(null);
 setUser(null);
 }, []);
