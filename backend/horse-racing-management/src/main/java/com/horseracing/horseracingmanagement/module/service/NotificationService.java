...
public interface NotificationService {
    void sendToUser(Long userId, String title, String content, String type, Long referenceId);
    void sendToAllAdmins(String title, String content, String type, Long referenceId);
